...
import SearchButton from '@/public/assets/icons/searchButton.svg'
import NotFoundImage from '@/public/assets/images/not_found.png'
        ...
        <>
          <div className="flex w-full justify-between items-center">
            ...
            <span className="ml-auto">
              <img src="/assets/icons/searchButton.svg"
                className="cursor-pointer"
                onClick={onSearchClick}
                data-testid={testingConstants.searchButton}alt={''}/>
            </span>
          </div>
