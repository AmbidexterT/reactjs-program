      ...
      <div className="flex flex-row relative">
        ...
        >
          ...
          <div className="flex ml-auto items-center">
            <img src="/assets/icons/arrowDown.svg" className={cx('flex justify-end items-center fill-current h-3 w-3', {
          ...
          <Controller
            ...
            render={({ field: { onChange } }) => (
              <ul
                className={cx(
                  'absolute w-full right-0 top-10 py-1 mt-2 bg-content z-2 shadow-modal select-none',
